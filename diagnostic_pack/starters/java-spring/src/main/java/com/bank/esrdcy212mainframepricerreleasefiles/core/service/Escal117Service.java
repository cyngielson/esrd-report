...
/**
 * ESCAL117 - COBOL program `ESCAL117` orchestrates a 1-step business flow. It emits 47 distinct return-code value(s) across 47 assignment site(s), driven by 1 state-machine flag group(s). Depends on 3 external copybook(s): RTCCPY, BILLCPY, WAGECPY.
 *
 * Risk: 53/100 (HIGH)
...
public class Escal117Service {
    ...
    /**
     * CALCULATION - L685-902
     * Branches: 26, GOTO: 0, CALLs: 2
     */
    ...
    private void _5000CalcCompRateFactors() {
        ...
        // COBOL: COMPUTE H-BSA-FACTOR  ROUNDED = CR-BSA ** ((H-BSA - 1.84) / .1)
        this.hBsaFactorRounded = Math.pow(crBsa, ((hBsa - 1.84) / .1));
        ...
        // COBOL: COMPUTE H-PYMT-AMT ROUNDED = (H-WAGE-ADJ-PYMT-AMT * H-BMI-FACTOR * H-BSA-FACTOR * CASE-MIX-BDGT-NEUT-FACTOR * H-AGE-FACTOR * DRUG-ADDON) + A-49-CENT-PART-D-DRUG-ADJ.
        this.hPymtAmtRounded = (hWageAdjPymtAmt * hBmiFactor * hBsaFactor * caseMixBdgtNeutFactor * hAgeFactor * drugAddon) + a49CentPartDDrugAdj;
