...
/**
 * ESCAL080 - COBOL program `ESCAL080` orchestrates a 1-step business flow. It emits 9 distinct return-code value(s) across 9 assignment site(s), driven by 0 state-machine flag group(s). Depends on 2 external copybook(s): BILLCPY, WAGECPY.
 *
 * Risk: 18/100 (LOW)
...
public class Escal080Service {
    ...
    private ReturnCodeResponse _0100InitialRoutine() {
        // IF (P-PROV-TYPE = '41'  THEN): RETURN CODE PPS-RTC = 52
        ...
        // COBOL: COMPUTE H-2008-WAGE-ADJ-PYMT ROUNDED = H-2007-WAGE-ADJ-PYMT * MSA-WAGE-FACTOR-2008
        this.h2008WageAdjPymtRounded = h2007WageAdjPymt * msaWageFactor2008;
