...
/**
 * ESCAL202 - COBOL program `ESCAL202` orchestrates a 1-step business flow. It emits 47 distinct return-code value(s) across 48 assignment site(s), driven by 1 state-machine flag group(s). Depends on 3 external copybook(s): RTCCPY, BILLCPY, WAGECPY.
 *
 * Risk: 43/100 (MEDIUM)
...
public class Escal202Service {
    ...
    /**
     * CALCULATION - L906-1316
     * Branches: 41, GOTO: 0, CALLs: 4
     */
    private void _2000CalculateBundledFactors() {
        ...
        // COBOL: COMPUTE H-FINAL-AMT-WITHOUT-HDPA = H-FINAL-AMT-WITHOUT-HDPA + H-TDAPA-PAYMENT.
        this.hFinalAmtWithoutHdpa = hFinalAmtWithoutHdpa + hTdapaPayment;

        // COBOL: COMPUTE H-FINAL-AMT-WITH-HDPA = H-FINAL-AMT-WITH-HDPA + H-TDAPA-PAYMENT.
        this.hFinalAmtWithHdpa = hFinalAmtWithHdpa + hTdapaPayment;
