...
/**
 * ESCAL212 - COBOL program `ESCAL212` orchestrates a 1-step business flow. It emits 47 distinct return-code value(s) across 48 assignment site(s), driven by 1 state-machine flag group(s). Depends on 3 external copybook(s): RTCCPY, BILLCPY, WAGECPY.
 *
 * Risk: 44/100 (MEDIUM)
...
public class Escal212Service {
    ...
    /**
     * CALCULATION - L947-1382
     * Branches: 43, GOTO: 0, CALLs: 4
     */
    private void _2000CalculateBundledFactors() {
        ...
        // COBOL: COMPUTE H-PER-DIEM-AMT-WITHOUT-HDPA ROUNDED = (H-BUN-ADJUSTED-BASE-WAGE-AMT * 3) / 7
        this.hPerDiemAmtWithoutHdpaRounded = (hBunAdjustedBaseWageAmt * 3) / 7;

        // COBOL: COMPUTE H-PER-DIEM-AMT-WITH-HDPA ROUNDED = ((H-BUN-ADJUSTED-BASE-WAGE-AMT * 3) / 7) * ETC-HDPA-PCT
        this.hPerDiemAmtWithHdpaRounded = ((hBunAdjustedBaseWageAmt * 3) / 7) * etcHdpaPct;

        // COBOL: COMPUTE H-FINAL-AMT-WITHOUT-HDPA ROUNDED = H-PER-DIEM-AMT-WITHOUT-HDPA
        this.hFinalAmtWithoutHdpaRounded = hPerDiemAmtWithoutHdpa;

        // COBOL: COMPUTE H-FINAL-AMT-WITH-HDPA ROUNDED = H-PER-DIEM-AMT-WITH-HDPA
        this.hFinalAmtWithHdpaRounded = hPerDiemAmtWithHdpa;
        ...
        // COBOL: COMPUTE H-FINAL-AMT-WITHOUT-HDPA ROUNDED = H-BUN-ADJUSTED-BASE-WAGE-AMT + H-BUN-WAGE-ADJ-TRAINING-AMT
        this.hFinalAmtWithoutHdpaRounded = hBunAdjustedBaseWageAmt + hBunWageAdjTrainingAmt;

        // COBOL: COMPUTE H-FINAL-AMT-WITH-HDPA ROUNDED = (H-BUN-ADJUSTED-BASE-WAGE-AMT * ETC-HDPA-PCT) + H-BUN-WAGE-ADJ-TRAINING-AMT
        this.hFinalAmtWithHdpaRounded = (hBunAdjustedBaseWageAmt * etcHdpaPct) + hBunWageAdjTrainingAmt;
        ...
        // COBOL: COMPUTE H-TPNIES-PAYMENT = (0.65 * B-PAYER-ONLY-VC-QG-AMT) / B-CLAIM-NUM-DIALYSIS-SESSIONS.
        this.hTpniesPayment = (0.65 * bPayerOnlyVcQgAmt) / bClaimNumDialysisSessions;

        // COBOL: COMPUTE H-FINAL-AMT-WITHOUT-HDPA = H-FINAL-AMT-WITHOUT-HDPA + H-TDAPA-PAYMENT + H-TPNIES-PAYMENT.
        this.hFinalAmtWithoutHdpa = hFinalAmtWithoutHdpa + hTdapaPayment + hTpniesPayment;

        // COBOL: COMPUTE H-FINAL-AMT-WITH-HDPA = H-FINAL-AMT-WITH-HDPA + H-TDAPA-PAYMENT + H-TPNIES-PAYMENT.
        this.hFinalAmtWithHdpa = hFinalAmtWithHdpa + hTdapaPayment + hTpniesPayment;
    ...
    private void _9100MoveResults() {
        ...
        // COBOL: COMPUTE H-FINAL-AMT-WITHOUT-HDPA    ROUNDED = H-FINAL-AMT-WITHOUT-HDPA * QIP-REDUCTION
        this.hFinalAmtWithoutHdpaRounded = hFinalAmtWithoutHdpa * qipReduction;

        // COBOL: COMPUTE H-FINAL-AMT-WITH-HDPA       ROUNDED = H-FINAL-AMT-WITH-HDPA * QIP-REDUCTION
        this.hFinalAmtWithHdpaRounded = hFinalAmtWithHdpa * qipReduction;
        ...
        // COBOL: COMPUTE H-FINAL-AMT-WITHOUT-HDPA ROUNDED = H-FINAL-AMT-WITHOUT-HDPA - H-NETWORK-REDUCTION.
        this.hFinalAmtWithoutHdpaRounded = hFinalAmtWithoutHdpa - hNetworkReduction;

        // COBOL: COMPUTE H-FINAL-AMT-WITH-HDPA ROUNDED = H-FINAL-AMT-WITH-HDPA - H-NETWORK-REDUCTION.
        this.hFinalAmtWithHdpaRounded = hFinalAmtWithHdpa - hNetworkReduction;
